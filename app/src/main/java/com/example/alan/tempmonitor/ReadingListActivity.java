                ...
                if (patrol_manager.getProgress() == patrol_manager.getItems().size()) {
                    ...
                    alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(ReadingListActivity.this, "You clicked yes button", Toast.LENGTH_SHORT).show();
                            getUsernameDialog();
                        }
                    });
                    ...
                    alertDialogBuilder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(ReadingListActivity.this, "You clicked no button", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    private void getUsernameDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(ReadingListActivity.this, m_Text, Toast.LENGTH_SHORT).show();
    ...
    public class SimpleItemRecyclerViewAdapter extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if (mValues.get(position).checked == 1) {
                ...
                holder.mTemp.setText(mValues.get(position).temp.toString() + "\u00b0" + "F" + mValues.get(position).checked + patrol_manager.getItems().get(position).content);
